    ...
    <div className="min-h-screen flex items-center justify-center px-6 bg-gray-50">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-700 flex items-center justify-center mx-auto mb-4">
        ...
        {sent ? (
          <div className="bg-green-50 border border-green-200 rounded-xl p-5 text-center">
            ...
            <Link to="/login" className="inline-block mt-4 text-sm text-indigo-600 hover:underline font-medium">
          ...
          <>
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              <Link to="/login" className="text-indigo-600 hover:underline">Volver al inicio de sesión</Link>
            </p>
          </>
        )}
      </div>
