...
const IconLogout = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 shrink-0">
    ...
    <path fillRule="evenodd" d="M19 10a.75.75 0 0 0-.75-.75H8.704l1.048-1.04a.75.75 0 1 0-1.004-1.115l-2.5 2.5a.75.75 0 0 0 0 1.11l2.5 2.5a.75.75 0 1 0 1.004-1.114L8.704 10.75H18.25A.75.75 0 0 0 19 10Z" clipRule="evenodd" />
  </svg>
);
const IconSettings = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 shrink-0">
    ...
    >
      ...
      <nav className="flex-1 px-3 py-4 flex flex-col gap-4 overflow-y-auto">
        <div className="space-y-0.5">
          <p className="text-slate-500 text-[10px] font-semibold uppercase tracking-widest px-2 pb-2">Menú</p>
          {links.map((link) => (
            <NavLink
              key={link.to}
              to={link.to}
      ...
      <div className="px-3 pb-4 border-t border-slate-700/50 pt-3">
        ...
        <button
          ...
          className="w-full flex items-center gap-2.5 px-2.5 py-2.5 lg:py-2 rounded-lg text-sm font-medium text-slate-500 hover:bg-red-500/10 hover:text-red-400 transition-all duration-100"
        >
          <IconLogout />
          Cerrar sesión
        </button>
